...
def check_dependencies():
    ...
    try:
        ...
        print("[!] Error: pyenchant is not installed")
        print("[*] Please install it using: pip install pyenchant")
        print("[*] On Linux you might also need: sudo apt-get install python3-enchant")
        sys.exit(1)
...
class RuleGen:
    ...
    def generate_advanced_words(self,password):
        ...
        if self.debug: print("[*] Preanalysis Password: %s" % password)
